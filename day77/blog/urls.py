...
urlpatterns = [
    path("search/<str:q>", views.PostSearch.as_view()),   # 127.0.0.1/blog/update_post/1
    path("delete_comment/<int:pk>", views.delete_comment),   # 127.0.0.1/blog/update_post/1
    path("update_comment/<int:pk>", views.CommentUpdate.as_view()),   # 127.0.0.1/blog/update_post/1
